...
alias pp="exec /home/make/git/picom/build/src/picom -f -b -D 3 --blur-method dual_kawase --backend glx  --experimental-backends --glx-no-stencil --glx-no-rebind-pixmap --blur-strength 4"
