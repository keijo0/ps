...
IUSE="${IUSE_SERVERS} debug +elogind font-util minimal selinux suid systemd test +udev unwind xcsecurity xinit"
RESTRICT="!test? ( test )"
...
DEPEND="${CDEPEND}
	...
	font-util? ( media-fonts/font-util )
"
RDEPEND="${CDEPEND}
	!systemd? ( gui-libs/display-manager-init )
	selinux? ( sec-policy/selinux-xserver )
	xorg? ( xinit? ( >=x11-apps/xinit-1.3.3-r1 ) )
"
BDEPEND="
	sys-devel/flex
"
